...
export const navLinks: NavLinkDef[] = [
  ...
  { href: "/calendar", label: "行事曆", icon: Calendar, roles: ["admin", "technician"], group: "daily" },
  { href: "/commissions", label: "佣金結算", icon: HandCoins, roles: ["admin"], group: "system" },
  { href: "/receivables", label: "應收帳款", icon: Wallet, roles: ["admin"], group: "system" },
  { href: "/einvoices", label: "電子發票", icon: ReceiptText, roles: ["admin"], group: "system" },
  { href: "/purchase-products", label: "採購商品", icon: Package, roles: ["admin"], group: "reference" },
  { href: "/inventory", label: "庫存管理", icon: Archive, roles: ["admin", "technician"], group: "reference" },
